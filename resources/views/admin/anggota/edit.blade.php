        ...
        <div class="form-container">
            <form action="{{ route('admin.anggota.update', $member->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="member_id" name="member_id" value="{{ old('member_id', $member->member_id) }}">
                    @error('member_id')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <button type="submit" class="submit-btn">Perbarui Anggota</button>
                <a href="{{ route('admin.anggota.index') }}" class="back-link">Batal</a>
            </form>
        </div>
    </div>
</body>
